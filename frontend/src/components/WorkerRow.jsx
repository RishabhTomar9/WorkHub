...
export default function WorkerRow({ worker, onUpdate, onRemove, onOpen, stats }) {
        ...
        <div className="flex items-center justify-between">
            ...
            {stats && (
              <div className="grid grid-cols-3 gap-4 mt-3">
                ...
                <div className="text-center">
                  ...
                  <div className={`text-base font-semibold ${(stats.remainingAmount || 0) > 0 ? 'text-yellow-400' : 'text-gray-400'}`}>
          ...
          <div className="flex gap-2 ml-4">
            ...
            <button
              ...
              onClick={() => window.confirm("Delete worker?") && onRemove(worker._id)}
              title="Delete Worker"
            >
              <FaTrash />
            </button>
